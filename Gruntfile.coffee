...
module.exports = (grunt) ->
    ...
    grunt.initConfig
        ...
        concurrent:
            server: ["coffee:dist", "compass:server", "less:server", "copy:styles"]
            color: ["coffee:dist", "compass:dist", "less:dist", "copy:styles"]
            dist: ["coffee", "compass:dist", "less:dist",  "copy:styles", "htmlmin"]
